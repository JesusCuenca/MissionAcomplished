        ...
        NetworkClient.Lobby.GetPlayersInRoom((successful, reply, error) =>
            {
                ...
                if (successful)
                {
                    ...
                    {
                        PlayerCustomData data =
                            player.GetCustomData<PlayerCustomData>();
                        Debug.Log("Player custom data: " + data);

                        GameObject playerGO =
                            Instantiate(this.PlayerListPrefab,
                            this.LobbyPlayerList.transform);
                        PlayerLobbyListController playerCtrl =
                            playerGO.GetComponent<PlayerLobbyListController>();
                        playerCtrl
                            .Initialize(data, player.id.Equals(reply.ownerId));
                    }
